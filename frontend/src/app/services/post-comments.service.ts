...
export class PostCommentsService {
  ...
  private commentsList: BehaviorSubject<Comment[]> = new BehaviorSubject<Comment[]>(this.comments)
  commentsList$: Observable<Comment[]> = this.commentsList.asObservable()

  getCommentsList(postId: string): void {
    this.commentsList.next(this.comments)
  }
}
